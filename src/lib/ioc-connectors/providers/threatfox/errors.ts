export type ThreatFoxErrorCode = "THREATFOX_CREDENTIAL_REQUIRED" | "THREATFOX_CREDENTIAL_INVALID" | "THREATFOX_AUTH_FAILED" | "THREATFOX_RATE_LIMITED" | "THREATFOX_TIMEOUT" | "THREATFOX_HTTP_ERROR" | "THREATFOX_RESPONSE_TOO_LARGE" | "THREATFOX_INVALID_JSON" | "THREATFOX_INVALID_RESPONSE" | "THREATFOX_QUERY_FAILED" | "THREATFOX_ITEM_LIMIT" | "THREATFOX_NO_SUPPORTED_ITEMS" | "THREATFOX_MAPPING_FAILED" | "THREATFOX_CONFIGURATION_INVALID";
