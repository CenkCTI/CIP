...
export function safeErr(e: unknown, status=400) { const code = safeAiErrorCode(e); return noStore({ error: safeAiErrorMessage(code), code }, { status: code.includes("rate") ? 429 : status }); }
