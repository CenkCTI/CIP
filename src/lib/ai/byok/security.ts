...
export function safeErr(e: unknown, status=400) { const code = e instanceof Error ? e.message : "request_failed"; return noStore({ error: code }, { status: code.includes("rate") ? 429 : status }); }
