...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!result) return <div role="status" className="card text-amber-200">DEGRADED · entity data UNKNOWN. The Node is unavailable; this does not mean the entity has no observations.</div>;
