...
Phase 2.2C.1's informational v1 cursor and intentional full-window remapping apply only to that historical delivery. Phase 2.2C.2 accepts safe v1 input, upgrades it in memory, persists strict provider-bound v2 after successful completion, and filters already-seen records before normalization. See [PHASE_2_2C2.md](PHASE_2_2C2.md).
